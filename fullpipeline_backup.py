...
def main():
    ...
    parser.add_argument("--video_dir", type=str, default="data/video_test_x", help="Thư mục chứa video đầu vào")
    parser.add_argument("--model_dir", type=str, default="model_yolo", help="Thư mục chứa mô hình YOLO")
    parser.add_argument("--output_dir", type=str, default="conten1911/runs_tlukf_xysr_vbox_short", help="Thư mục đầu ra cho kết quả")
